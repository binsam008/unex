...
export default function ContactOffices() {
  ...
  const renderCard = (b, i, isMain = true) => (
    <div
      key={i}
      className={`group relative backdrop-blur-2xl bg-white/70 border ${
        isMain ? 'border-orange-100/50' : 'border-indigo-100/50'
        ...
        {b.phone ? (
          <div className="mt-8 pt-6 border-t border-gray-100/50">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className={`inline-flex items-center justify-between w-full py-3.5 px-5 rounded-2xl font-bold text-sm transition-all duration-300 shadow-sm ${
                isMain 
